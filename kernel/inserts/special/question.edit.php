...
namespace Pure\Inserts\Special\Report\Edit{
    ...
    \Pure\Components\Tools\DebugMarks\Marks::instance()->open('question.edit.php');
...
//Layout of page
    ...
    $layoutClass        = \Pure\Templates\Layout\Special\QuestionEdit\Initialization::instance()->get($BuddyPressSettings->header_template->value);
    echo $layoutClass->get($post_id);
    $layoutClass        = NULL;
    $BuddyPressSettings = NULL;
    \Pure\Components\Tools\DebugMarks\Marks::instance()->close('question.edit.php');
}
?>