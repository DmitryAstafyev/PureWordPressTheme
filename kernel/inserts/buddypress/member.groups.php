<?php
namespace Pure\Inserts\BuddyPress\Groups {
    \Pure\Components\Tools\DebugMarks\Initialization::instance()->attach();
    \Pure\Components\Tools\DebugMarks\Marks::instance()->open('member.groups.php');
    ...
    $WordPress          = NULL;
    //Layout of page
    $layoutClass        = \Pure\Templates\Layout\BuddyPress\Groups\Initialization::instance()->get($BuddyPressSettings->header_template->value);
    echo $layoutClass->get($member);
    $layoutClass        = NULL;
    $BuddyPressSettings = NULL;
    \Pure\Components\Tools\DebugMarks\Marks::instance()->close('member.groups.php');
}
?>