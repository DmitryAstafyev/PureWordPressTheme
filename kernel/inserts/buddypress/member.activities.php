<?php
namespace Pure\Inserts\BuddyPress\Member{
    \Pure\Components\Tools\DebugMarks\Initialization::instance()->attach();
    \Pure\Components\Tools\DebugMarks\Marks::instance()->open('member.activities.php');
    ...
    $WordPress          = NULL;
    //Layout of page
    $layoutClass        = \Pure\Templates\Layout\BuddyPress\Member\Initialization::instance()->get($BuddyPressSettings->header_template->value);
    echo $layoutClass->get($member);
    $layoutClass        = NULL;
    $BuddyPressSettings = NULL;
    \Pure\Components\Tools\DebugMarks\Marks::instance()->close('member.activities.php');
}
?>