<?php
if (isset($_POST['PureLayoutScheme']) !== false){
    $currentTemplate = $_POST['PureLayoutScheme'];
    //echo var_dump($currentTemplate);
}else{
    ...
    $currentTemplate    = $parameters->template;
}
/**
 ...
 */
/*D.Astafyev:: load only front-page-sidebars*/
\Pure\Components\WordPress\PageByScheme\Initialization::instance()->attach();
$FrontPageBuilder   = new \Pure\Components\WordPress\PageByScheme\Core();
$pageSidebars       = $FrontPageBuilder->loadSidebars($currentTemplate);

//echo var_dump($pageSidebars);
/** WordPress Administration Bootstrap */
require_once( \Pure\Configuration::instance()->dir(ABSPATH . 'wp-admin/includes/admin.php') );

/** WordPress Administration Widgets API */
require_once(\Pure\Configuration::instance()->dir(ABSPATH . 'wp-admin/includes/widgets.php'));
global $wp_registered_sidebars;/*D.Astafyev:: It should be right after require_once(ABSPATH . 'wp-admin/includes/widgets.php');*/
...
if ( isset($_GET['editwidget']) && $_GET['editwidget'] ) {
    ...
    require_once( \Pure\Configuration::instance()->dir(ABSPATH . 'wp-admin/admin-header.php') ); ?>
    <div class="wrap">
    ...
    <?php
    require_once( \Pure\Configuration::instance()->dir(ABSPATH . 'wp-admin/admin-footer.php') );
    exit;
}
...
require_once( \Pure\Configuration::instance()->dir(ABSPATH . 'wp-admin/admin-header.php') ); ?>
    ...
    <div class="wrap">
        ...
        <div class="widget-liquid-left">
            <div id="widgets-left">
                ...
                foreach ( $wp_registered_sidebars as $sidebar => $registered_sidebar ) {
                    if ( isset($pageSidebars[$sidebar]) === false || false !== strpos( $registered_sidebar['class'], 'inactive-sidebar' ) || 'orphaned_widgets' == substr( $sidebar, 0, 16 ) ) {
                        ...
                        <div class="<?php echo esc_attr( $wrap_class ); ?>">
                            <div class="widget-holder inactive" style="display: none;">
        ...
        <div class="widget-liquid-right">
            <?php
            echo $FrontPageBuilder->getSchemes($currentTemplate);
            ?>
            <div id="widgets-right"<?php echo $single_sidebar_class; ?>>
                <?php
                echo $FrontPageBuilder->getSidebars($currentTemplate);
                ?>
            </div>
        </div>
