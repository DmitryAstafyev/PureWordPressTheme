...
namespace Pure\Providers\Members{
    class users_of_popular implements \Pure\Providers\Provider{
        ...
        public function get($parameters){
            ...
            if ($this->validate($parameters) === true && $Common->validate($parameters) === true){
                ...
                $users_data     = $wpdb->get_results( 'SELECT DISTINCT post_author FROM wp_posts WHERE '.$where.' AND post_status="publish" AND post_type="post" ORDER BY comment_count DESC');
