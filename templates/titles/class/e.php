    ...
    class E{
        ...
        public function get($title, $parameters = NULL){
            ...
            $innerHTML =    '<!--BEGIN: Title -->'.
                            ...
                            '<div data-element-type="Pure.Title.E">'.
                                '<div data-element-type="Pure.Title.E.Container">';
            if ($parameters->link->href !== ''){
                $innerHTML .=       '<a data-element-type="Pure.Title.E" href="'.$parameters->link->href.'" target="'.$parameters->link->tagret.'"><strong>'.$title.'</strong></a>';
            }else{
                $innerHTML .=       '<p data-element-type="Pure.Title.E"><strong>'.$title.'</strong></p>';
            }
            $innerHTML .=       '</div>'.
                            '</div>'.
                            '<!--END: Title -->';
