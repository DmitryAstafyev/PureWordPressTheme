    ...
    class H{
        ...
        public function get($title, $parameters = NULL){
            ...
            $innerHTML =    '<!--BEGIN: Title -->'.
                            ...
                            '<div data-element-type="Pure.Title.H">'.
                                '<div data-element-type="Pure.Title.H.Container">';
            if ($parameters->link->href !== ''){
                $innerHTML .=       '<a data-element-type="Pure.Title.H" href="'.$parameters->link->href.'" target="'.$parameters->link->tagret.'"><strong>'.$title.'</strong></a>';
            }else{
                $innerHTML .=       '<p data-element-type="Pure.Title.H">'.$title.'</p>';
            }
            $innerHTML .=       '</div>'.
                            '</div>'.
                            '<!--END: Title -->';
