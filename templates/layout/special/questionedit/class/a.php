<?php
namespace Pure\Templates\Layout\Special\QuestionEdit{
    class A{
        public function get($post_id = false){
            $Editor             = \Pure\Templates\Pages\QuestionEditor\Initialization::instance()->get('A');
            $innerHTMLEditor    = Initialization::instance()->html(
                'A/one_column_segment_tab',
                array(
                    array('title',      ($post_id === false ? __('Create question', '') : __('Edit question', '')) ),
