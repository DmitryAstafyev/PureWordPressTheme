<?php
namespace Pure\Templates\Layout\Special\Top\Reports{
    class A{
        ...
        private function innerHTMLBlock($container_id){
            ...
            $innerHTML  = ($innerHTML !== '' ? $innerHTML : '<p data-element-type="Pure.Social.Home.A.Message">No reports</p>');
            $wrapper    = NULL;
            $posts      = NULL;
            return $innerHTML;
        }
        public function get(){
            ...
            $innerHTMLTitle         = Initialization::instance()->html(
                'A/about',
                array(
                    array('name',   __('Most popular report', 'pure')       ),
