<?php
namespace Pure\Templates\Layout\Special\GroupContent{
    class A{
        ...
        private function innerHTMLBlock($group_id, $container_id, $post_type){
            switch($post_type){
                case 'post':
                    $template   = 'F';
        ...
        public function get($group_id){
            ...
            if ((int)$group_id > 0){
                ...
                if ($group !== false){
                    ...
                    $counts                 = $PostsProvider->get_groups_posts_counts_by_types(array($group_id));
                    ...
                    foreach($labelsIDs as $key=>$value){
                        $innerHTMLPosts .= Initialization::instance()->html(
                            ...
                            array(
                                ...
                                array('content',        $this->innerHTMLBlock($group_id, $value, $key)          ),
                            )
                        );
                    }
