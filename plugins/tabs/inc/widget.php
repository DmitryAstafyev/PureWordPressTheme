    ...
    class Widget extends \WP_Widget {
        ...
        public function widget($args, $instance)
        {
            ...
            try{
                ...
                $ErrorMessages->show("\\Pure\\Plugins\\Tabs\\Widget\\widget::: ".$e);
                $ErrorMessages = NULL;
                return NULL;
            }
        }
        public function update($new_instance, $old_instance)
        {
            ...
            if ( isset ( $new_instance['images'] ) ){
                foreach ( $new_instance['images'] as $value ){
                    array_push($instance['images'], $value);
                }
            }
            if ( isset ( $new_instance['captions'] ) ){
                foreach ( $new_instance['captions'] as $value ){
                    array_push($instance['captions'], $value);
                }
            }
        ...
        public function form($instance)
        {
            ...
            $templates          = \Pure\Templates\PresentationTabs\Initialization       ::instance()->templates;
            ...
            $groups->open(array(
                ...
                "echo"  =>true));
            ?>
            <p>Choose template of tabs container</p>
            <?php
            foreach ($templates as $_template){
                ...
                <p>
                    ...
                    <?php
                    \Pure\Templates\PresentationTabs\Initialization::instance()->description($_template->key);
                    ?>
                </p>
            <?php
            }
            ...
            for($index = 0; $index < count($icons); $index ++){
                if ($icons[$index] !== ''){
                    ...
                    if (is_array($attachment) !== false){
                        ...
                        $icon_url = Initialization::instance()->configuration->urls->images.'/no_image.png';
                    }
                }else{
                    $icon_url = Initialization::instance()->configuration->urls->images.'/no_image.png';
                }
                if ($images[$index] !== ''){
                    $attachment = wp_get_attachment_image_src( $images[$index], 'thumbnail', false );
                    if (is_array($attachment) !== false){
                        $image_url = $attachment[0];
                    }else{
                        $image_url = Initialization::instance()->configuration->urls->images.'/no_image.png';
                    }
                }else{
                    $image_url = Initialization::instance()->configuration->urls->images.'/no_image.png';
                }
        ...
        private function innerHTMLItem($containers, $posts, $pages, $index, $posts_titles, $pages_titles, $data){
            ...
            $icons_storage  = uniqid();
            $images_storage = uniqid();
            ?>
            <p data-element-type="Pure.Admin.Title">Caption</p>
            <p>
                <label for="<?php echo $this->get_field_id( 'captions' ); ?>[<?php echo $index; ?>]">Caption of item</label>
                <textarea data-element-type="Pure.Admin.TextArea" id="<?php echo $this->get_field_id( 'captions' ); ?>[<?php echo $index; ?>]" name="<?php echo $this->get_field_name( 'captions' ); ?>[<?php echo $index; ?>]" type="text"><?php echo $data->caption; ?></textarea>
            </p>
            <p>Choose an icon of caption</p>
            <div data-element-type="Pure.Admin.Preview.Image.Container">
                <img data-element-type="Pure.Admin.Preview.Image" src="<?php echo $data->icon_url; ?>" data-storage-id="<?php echo $icons_storage; ?>" pure-wordpress-media-images-default-src="<?php echo Initialization::instance()->configuration->urls->images.'/no_image.png' ?>"/>
                <div data-element-type="Pure.Admin.Preview.Image.Controls.Container">
                    <div data-element-type="Pure.Admin.Preview.Image.Button" data-addition-type="Load" pure-wordpress-media-images-add-selector="*[data-storage-id=|<?php echo $icons_storage; ?>|]" pure-wordpress-media-images-displayed>load</div>
                    <div data-element-type="Pure.Admin.Preview.Image.Button" data-addition-type="Remove" pure-wordpress-media-images-remove-selector="*[data-storage-id=|<?php echo $icons_storage; ?>|]" pure-wordpress-media-images-displayed>remove</div>
                </div>
            </div>
            <input data-element-type="Pure.Admin.Preview.Image" data-storage-id="<?php echo $icons_storage; ?>" id="<?php echo $this->get_field_id( 'icons' ); ?>[<?php echo $index; ?>]" name="<?php echo $this->get_field_name( 'icons' ); ?>[<?php echo $index; ?>]" value="<?php echo $data->icon_id; ?>" type="text"/>
            <p data-element-type="Pure.Admin.Title">Tab content</p>
            <p>
            ...
            <p>Choose an image</p>
            <div data-element-type="Pure.Admin.Preview.Image.Container">
                <img data-element-type="Pure.Admin.Preview.Image" src="<?php echo $data->image_url; ?>" data-storage-id="<?php echo $images_storage; ?>" pure-wordpress-media-images-default-src="<?php echo Initialization::instance()->configuration->urls->images.'/no_image.png' ?>"/>
                <div data-element-type="Pure.Admin.Preview.Image.Controls.Container">
                    <div data-element-type="Pure.Admin.Preview.Image.Button" data-addition-type="Load" pure-wordpress-media-images-add-selector="*[data-storage-id=|<?php echo $images_storage; ?>|]" pure-wordpress-media-images-displayed>load</div>
                    <div data-element-type="Pure.Admin.Preview.Image.Button" data-addition-type="Remove" pure-wordpress-media-images-remove-selector="*[data-storage-id=|<?php echo $images_storage; ?>|]" pure-wordpress-media-images-displayed>remove</div>
                </div>
            </div>
            <input data-element-type="Pure.Admin.Preview.Image" data-storage-id="<?php echo $images_storage; ?>" id="<?php echo $this->get_field_id( 'images' ); ?>[<?php echo $index; ?>]" name="<?php echo $this->get_field_name( 'images' ); ?>[<?php echo $index; ?>]" value="<?php echo $data->image_id; ?>" type="text"/>
        ...
        private function innerHTMLTemplateItem($containers, $posts, $pages){
            ...
            <div data-muliitems-index-template="<?php echo $this->get_field_id( 'Items' );?>[[index]]"
                ...
                <p data-element-type="Pure.Admin.Title">Caption</p>
                <p>
                    <label for="<?php echo $this->get_field_id( 'captions' ); ?>[[index]]">Caption of item</label>
                    <textarea data-element-type="Pure.Admin.TextArea" id="<?php echo $this->get_field_id( 'captions' ); ?>[[index]]" name="<?php echo $this->get_field_name( 'captions' ); ?>[[index]]" type="text" value=""></textarea>
                </p>
                <p>Choose an icon of caption</p>
                <div data-element-type="Pure.Admin.Preview.Image.Container">
                    <img data-element-type="Pure.Admin.Preview.Image" src="<?php echo Initialization::instance()->configuration->urls->images.'/no_image.png' ?>" data-storage-id="<?php echo $icons_storage; ?>[index]" pure-wordpress-media-images-default-src="<?php echo Initialization::instance()->configuration->urls->images.'/no_image.png' ?>"/>
                    <div data-element-type="Pure.Admin.Preview.Image.Controls.Container">
                        <div data-element-type="Pure.Admin.Preview.Image.Button" data-addition-type="Load" pure-wordpress-media-images-add-selector="*[data-storage-id=|<?php echo $icons_storage; ?>[index]|]" pure-wordpress-media-images-displayed>load</div>
                        <div data-element-type="Pure.Admin.Preview.Image.Button" data-addition-type="Remove" pure-wordpress-media-images-remove-selector="*[data-storage-id=|<?php echo $icons_storage; ?>[index]|]" pure-wordpress-media-images-displayed>remove</div>
                    </div>
                </div>
                <input data-element-type="Pure.Admin.Preview.Image" data-storage-id="<?php echo $icons_storage; ?>[index]" id="<?php echo $this->get_field_id( 'icons' ); ?>[[index]]" name="<?php echo $this->get_field_name( 'icons' ); ?>[[index]]" value="" type="text"/>
                ...
                <p>Choose an image of tab</p>
                <div data-element-type="Pure.Admin.Preview.Image.Container">
                    <img data-element-type="Pure.Admin.Preview.Image" src="<?php echo Initialization::instance()->configuration->urls->images.'/no_image.png' ?>" data-storage-id="<?php echo $images_storage; ?>[index]" pure-wordpress-media-images-default-src="<?php echo Initialization::instance()->configuration->urls->images.'/no_image.png' ?>"/>
                    <div data-element-type="Pure.Admin.Preview.Image.Controls.Container">
                        <div data-element-type="Pure.Admin.Preview.Image.Button" data-addition-type="Load" pure-wordpress-media-images-add-selector="*[data-storage-id=|<?php echo $images_storage; ?>[index]|]" pure-wordpress-media-images-displayed>load</div>
                        <div data-element-type="Pure.Admin.Preview.Image.Button" data-addition-type="Remove" pure-wordpress-media-images-remove-selector="*[data-storage-id=|<?php echo $images_storage; ?>[index]|]" pure-wordpress-media-images-displayed>remove</div>
                    </div>
                </div>
                <input data-element-type="Pure.Admin.Preview.Image" data-storage-id="<?php echo $images_storage; ?>[index]" id="<?php echo $this->get_field_id( 'images' ); ?>[[index]]" name="<?php echo $this->get_field_name( 'images' ); ?>[[index]]" value="" type="text"/>
                <p data-element-type="Pure.Admin.Title">Choose link of item</p>
                <p>
