    ...
    class Widget extends \WP_Widget {
        ...
        public function widget($args, $instance)
        {
            ...
            $_parameters    = array(	'title'		    => $instance['title'		],
                                        ...
                                        'subcaptions'   => $instance['subcaptions'  ],
            ...
            try{
                ...
                $ErrorMessages->show("\\Pure\\Plugins\\Popups\\Widget\\widget::: ".$e);
                $ErrorMessages = NULL;
                return NULL;
            }
        }
        public function update($new_instance, $old_instance)
        {
            ...
            if ( isset ( $new_instance['subcaptions'] ) ){
                foreach ( $new_instance['subcaptions'] as $value ){
                    array_push($instance['subcaptions'], $value);
                }
            }
        ...
        public function form($instance)
        {
            ...
            $templates          = \Pure\Templates\Popups\Initialization                 ::instance()->templates;
            ...
            $subcaptions        = isset( $instance[ 'subcaptions'   ] )  ? $instance[ 'subcaptions'     ] : array();
            ...
            $groups->open(array(
                ...
                "echo"  =>true));
            ?>
            <p>Choose template of hightlights</p>
            <?php
            foreach ($templates as $_template){
                ...
                <p>
                    ...
                    <?php
                    \Pure\Templates\Popups\Initialization::instance()->description($_template->key);
                    ?>
                </p>
            <?php
            }
        ...
        private function innerHTMLItem($containers, $posts, $pages, $index, $posts_titles, $pages_titles, $data){
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'subcaptions' ); ?>[<?php echo $index; ?>]">Sub caption of item</label>
                <textarea data-element-type="Pure.Admin.TextArea" id="<?php echo $this->get_field_id( 'subcaptions' ); ?>[<?php echo $index; ?>]" name="<?php echo $this->get_field_name( 'subcaptions' ); ?>[<?php echo $index; ?>]" type="text"><?php echo $data->subcaption; ?></textarea>
            </p>
            <p data-element-type="Pure.Admin.Title">Popup</p>
            <p>
        ...
        private function innerHTMLTemplateItem($containers, $posts, $pages){
            ...
            <div data-muliitems-index-template="<?php echo $this->get_field_id( 'Items' );?>[[index]]"
                ...
                <p>
                    <label for="<?php echo $this->get_field_id( 'subcaptions' ); ?>[[index]]">Sub caption of item</label>
                    <textarea data-element-type="Pure.Admin.TextArea" id="<?php echo $this->get_field_id( 'subcaptions' ); ?>[[index]]" name="<?php echo $this->get_field_name( 'subcaptions' ); ?>[[index]]" type="text" value=""></textarea>
                </p>
