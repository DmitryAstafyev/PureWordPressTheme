...
namespace Pure\Components\webSocketServer\Module{
    class Server {
        ...
        private function initHeartBeatStack(){
            $this->heartbeat_stack  = new HeartbeatStack();
        }
        private function initConnections(){
            $this->connections      = new Connections($this->uniqid, $this->settings);
        }
        ...
        public function proceed(){
            $Heartbeat = new HeartbeatWorker(
                $this->uniqid,
                $this->heartbeat_stack,
                $this->settings
            );
            $Heartbeat->start(PTHREADS_INHERIT_NONE);
