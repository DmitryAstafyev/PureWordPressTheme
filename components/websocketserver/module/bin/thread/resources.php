...
namespace Pure\Components\webSocketServer\Module {
    class Resources{
        ...
        private $classes = array(
            ...
            //Module resources
            'HeartbeatWorker'   =>array('type'=>'bin', 'file'=>'thread/heartbeat.worker.php'            ),
            'HeartbeatStack'    =>array('type'=>'bin', 'file'=>'thread/heartbeat.stack.php'             ),
            'Heartbeat'         =>array('type'=>'bin', 'file'=>'thread/heartbeat.class.php'             ),
            'ConnectionWorker'  =>array('type'=>'bin', 'file'=>'thread/connection.worker.php'           ),
            'Connections'       =>array('type'=>'bin', 'file'=>'thread/connections.class.php'           ),
            'Server'            =>array('type'=>'bin', 'file'=>'thread/server.class.php'                ),
            //Jobs of connection
            'GetRequire'        => array('type'=>'bin', 'file'=>'thread/jobs/auth.require.get.php'      ),
            'SendRequire'       => array('type'=>'bin', 'file'=>'thread/jobs/auth.require.send.php'     ),
            //Core resources
